...
Hi,  
我是 wan (丸)，目前正在努力學習韓文中。  
因為我記憶力很差，  
所以就運用免費的 AI 額度弄了一個 單字小工具，
想要幫助自己背單字。 
...
之後更新的資訊會公告在 [wankorean](https://www.threads.com/@wankorean)。

#### [ 使用須知 ]
1. 因為是用免費的 AI 製作的，所以它會壞掉，壞掉重開就可以了。
2. 版面可能有點醜或跑版，需要忽視它 (在資源有限的情況下先犧牲它)。
3. 單字會繼續慢慢整理更新，可能會有錯誤，可以再通知我。
4. 網站只會記錄姓名還有測驗的結果，建議用個不太會重複的名字，可以一直紀錄下去。
